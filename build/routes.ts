...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/tasks/toggle/:taskId',
            ...(fetchMiddlewares<RequestHandler>(TasksController)),
            ...(fetchMiddlewares<RequestHandler>(TasksController.prototype.toggleTask)),
            ...
            try {
              ...
              const promise = controller.toggleTask.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/tasks/markAll/:setting',
            ...(fetchMiddlewares<RequestHandler>(TasksController)),
            ...(fetchMiddlewares<RequestHandler>(TasksController.prototype.toggleAll)),
            ...
            try {
              ...
              const promise = controller.toggleAll.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
